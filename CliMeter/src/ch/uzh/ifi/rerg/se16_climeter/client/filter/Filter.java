...
public class Filter implements IsSerializable {
	...
	private boolean groupByCountry = false;
	 ...
	 * @pre -
	 * @post -
	 * @param groupByCountry the groupByCountry to set
	 */
	...
	public int hashCode() {
		...
		result = prime * result + (groupByCountry ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (endDateString == null) {
			...
			return false;
		if (groupByCountry != other.groupByCountry)
			return false;
